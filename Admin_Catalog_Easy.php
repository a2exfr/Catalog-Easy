...
class Admin_Catalog_Easy{
	...
	function __construct(){
		$this->var_names = [
			...
			'AbbrevL',
			'item_per_pageL', 'ImagesizeWL', 'ImagesizeHL', 'ShowImageL', 'ShowSortingL',
			'ImageCircleL',
			'item_per_page3c', 'ShowImage3c', 'ShowSorting3c', 'ImageCircle3c', 'ImagesizeW3c',
			'ImagesizeH3c',
			'item_per_page2c', 'ShowSorting2c', 'ShowImage2c', 'ImageCircle2c', 'ImagesizeW2c',
			'ImagesizeH2c',
...
//Default option panel
		...
		$select_data = [
			0 => 'List', 1 => '3 columns', 2 => '2 columns', 3 => 'Portfolio Gallery',
			4 => 'Carousel', 5 => 'Sortable Portfolio',
		];
		...
		$rad_1 = "";
		$rad_2 = "";
		if ($this->ShortInfo == "sect"){
			$rad_1 = 'checked="checked"';
		} else {
			$rad_2 = 'checked="checked"';
		}
...
//special option panel
		...
		echo '</p>';
		$select_data_style = [0 => 'Links', 1 => 'Arrows', 2 => 'Arrows2', 3 => 'Arrows3'];
		...
		echo '</p>';
		$select_data_style2 = [0 => 'Buttons in line', 1 => 'Buttons on both sides'];
		...
		$select_readmore = [0 => 'Icon', 1 => 'Text link'];
...
//page manager panel
		...
		$select_data2 = [
			0 => 'Direct ChildPages', 1 => 'ChildPages from  another page',
			2 => 'From page in another menu',
		];
		$select_data3 = [
			0 => 'All, items per page=', 1 => 'First number =', 2 => 'Last number =',
			3 => 'Random number =',
		];
...
//help&about panel
	...
	function saveConfig(){
		...
		//checkboxes
		$checkboxes = [
			'ShowImageL', 'ShowSortingL', 'ImageCircleL',
		...
		//
		if ($_POST){
			$_POST["datafilter"] = array_diff($_POST["datafilter"], ['']);
